...
uint8_t HTU21_ADDR = 0x40; // 0b1000000

// HTU21 device commands
uint8_t HTU21_RESET_COMMAND = 0xFE;
uint8_t HTU21_READ_TEMPERATURE_W_HOLD_COMMAND = 0xE3;
uint8_t HTU21_READ_TEMPERATURE_WO_HOLD_COMMAND = 0xF3;
uint8_t HTU21_READ_HUMIDITY_W_HOLD_COMMAND = 0xE5;
uint8_t HTU21_READ_HUMIDITY_WO_HOLD_COMMAND = 0xF5;
uint8_t HTU21_READ_SERIAL_FIRST_8BYTES_COMMAND_MSB = 0xFA;
uint8_t HTU21_READ_SERIAL_FIRST_8BYTES_COMMAND_LSB = 0x0F;
uint8_t HTU21_READ_SERIAL_LAST_6BYTES_COMMAND_MSB = 0xFC;
uint8_t HTU21_READ_SERIAL_LAST_6BYTES_COMMAND_LSB = 0xC9;
uint8_t HTU21_WRITE_USER_REG_COMMAND = 0xE6;
uint8_t HTU21_READ_USER_REG_COMMAND = 0xE7;
